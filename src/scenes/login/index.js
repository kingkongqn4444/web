      ...
      <div id="extr-page">
        <header id="header" className="animated fadeInDown">
          <div id="logo-group">
            <span id="logo">
              {" "}
              <img src="/assets/img/logo.png" alt="PPMS" />{" "}
            </span>
          </div>
        </header>
          ...
          <div id="content" className="container">
            <div className="row">
              <div className="col-xs-12 col-sm-12 col-md-7 col-lg-8 hidden-xs hidden-sm">
                <h1 className="txt-color-red login-header-big">PPMS</h1>

                <div className="hero">
                  <div className="pull-left login-desc-box-l">
                    <h4 className="paragraph-header">
                      Lorem ipsum dolor sit amet, consectetur adipiscing elit.
                      Fusce non vehicula leo, ut congue augue. Phasellus dictum
                      lacus quis efficitur ultricies. Suspendisse potenti.
                      Nullam tempor tortor ac convallis ultrices. Sed porttitor,
                      enim id eleifend hendrerit, sem risus feugiat massa, sed
                      mattis lectus est vel augue. Mauris at magna in lorem
                      fermentum gravida. Suspendisse in eleifend justo.
                    </h4>
                  </div>
                  <img
