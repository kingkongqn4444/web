            ...
            <div className="modal-dialog">
                <div className="modal-content">
                    <div className="modal-header">
                        ...
                        <h4 className="modal-title" id="myModalLabel">{this.props.data.type==="Create"?"Tạo mới nhóm quyền":"Chỉnh sửa nhóm quyền"}</h4>
                    </div>
                            ...
                            <BootstrapValidator>
                                <form id="attributeForm"  className="smart-form"
                                    ...
                                    <fieldset>
                                        <section className="form-group">
                                            ...
                                            <label className="input">
                                                <input type="text" className="input-xs" name="name" value={this.state.name} onChange={this.handleChangeName}
                                        ...
                                        <section className="form-group">
                                            ...
                                            <label className="input">
                                                <input type="text" className="input-xs" name="bref" value={this.state.bref} onChange={this.handleChangeBref}
                                                       placeholder="Mổ tả"
                                                       data-bv-notempty="true"
                                                ...
                                                <div className="panel-body">
                                                    <div className="table-responsive">
                                                        <table className="table table-striped table-bordered table-hover">
                                                            ...
                                                            <Data rows={this.props.data.permission} type={this.props.data.type}/>
                                                        </table>
                                                    </div>
                                                </div>
                                            </div>
                                    ...
                                    <footer>
                                        ...
                                        <button type="button" className="btn btn-primary" onClick={this.onSubmit.bind(this)}>Xác nhận</button>
