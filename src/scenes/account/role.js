    ...
    render() {
        return (
            <div id="content">
                        ...
                        <ul id="sparks" className="">
                            <li className="sparks-info">
                                <button className="btn btn-primary btn-lg" data-toggle="modal"
                                        data-target="#myModal" onClick={() => this.setData("", "", [], "Create")}>
                                    Tao Nhom Quyen Moi
                                </button>
                            </li>
                        </ul>
                ...
                <article>
                    <div><PopupForm data={this.state}/></div>
                            ...
                            <div className="widget-body no-padding">
                                ...
                                <div className="table-responsive">
                                    ...
                                    <table className="table table-bordered table-striped table-hover">
                                        ...
                                        <tbody>
                                        {
                                            Data.data.map((data, i) => (<tr key={i}>
                                                <td>{data.id}</td>
                                                <td>{data.role}</td>
                                                <td>{data.bref}</td>
                                                <td>{data.date}</td>
                                                <td><a href="#" data-toggle="modal" data-target="#myModal"
                                                       onClick={() => this.setData(data.role, data.bref, data.permission, "Edit")}>Edit</a>
                                                </td>
                                            </tr>))
                                        }
                                        </tbody>
