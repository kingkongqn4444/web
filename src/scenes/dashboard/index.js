                      ...
                      <ul className="bs-glyphicons">
                        <li>
                          ...
                          >
                            ...
                            <span className="glyphicon-class">Account</span>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            ...
                            <span className="glyphicon-class">Widget</span>
                          </a>
                        </li>
                        <li>
                          <a
                          ...
                          >
                            ...
                            <span className="glyphicon-class">Sản phẩm</span>
                          </a>
                        </li>
                        <li>
                          <a
                        ...
                        <li>
                          ...
                          >
                            ...
                            <span className="glyphicon-class">Kho chứa</span>
                          </a>
                        </li>
                        <li>
                          <a
