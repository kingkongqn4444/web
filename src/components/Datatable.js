...
export default class Datatable extends React.Component {
  ...
  datatable() {
    ...
    if (!toolbar) {
      element.parent().find(".dt-toolbar").append('<div class="text-right"><img src="assets/img/logo.png" alt=" Danh sách tài khoản" style="width: 111px; margin-top: 3px; margin-right: 10px;"></div>');
    }
